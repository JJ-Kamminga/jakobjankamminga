  ...
  return (
    <Typography
      ...
      sx={{
        ...
        borderRight:
          accent == "right" ? "4px solid var(--main-teal)" : undefined,
      }}
    >
      {children}
    </Typography>
...
export const AboutSection = () => {
  return (
    <p style={{ fontSize: "2rem" }}>
      ...
      <Spacer />
      <Spacer />
      <Typography style={{ textAlign: "left", fontSize: "2.5rem" }}>
        80% asking questions.
      </Typography>
      <PipelineGraph />
      <Typography style={{ textAlign: "right", fontSize: "1.5rem" }}>
      ...
      >
        <Link
          target="_blank"
          href="https://www.linkedin.com/in/jakobjankamminga/"
        >
          Get in touch
        </Link>
      </Typography>
